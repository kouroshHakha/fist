...
env = AttrDict(
    task_list = ['microwave', 'bottom burner', 'light switch', 'slide cabinet']
)
...
model_config = AttrDict(
    ...
    cond_decode=True,
    # checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/kitchen/hierarchical_cl_gc_no_microwave'
)
