...
fewshot_dataset = KitchenStateSeqDataset(
    data_path='data/kitchen/kitchen-demo-microwave-bottomknob-switch-slide.hdf5',
    subseq_len=10,
)
...
configuration = {
    ...
    'contra_ckpt': './experiments/contrastive/kitchen/exact/exact_model.pt'
}
...
model_config = AttrDict(
    ...
    cond_decode=True,
    # checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/kitchen/hierarchical_cl_no_microwave'
)

# Dataset
data_config = AttrDict()
data_config.dataset_spec = data_spec
data_config.dataset_spec['dataset_path'] = './data/kitchen/kitchen-mixed-no-microwave.hdf5'
