...
fewshot_dataset = KitchenStateSeqDataset(
    data_path='data/kitchen/kitchen-demo-kettle_bottomknob_switch_hinge.hdf5',
    subseq_len=10,
)

env = AttrDict(
    task_list = ['kettle', 'bottom burner', 'light switch', 'hinge cabinet']
)
...
model_config = AttrDict(
    ...
    cond_decode=True,
    checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/kitchen/hierarchical_cl_gc_no_switch'
)

# Dataset
data_config = AttrDict()
data_config.dataset_spec = data_spec
data_config.dataset_spec['dataset_path'] = './data/kitchen/kitchen-mixed-no-switch.hdf5'
