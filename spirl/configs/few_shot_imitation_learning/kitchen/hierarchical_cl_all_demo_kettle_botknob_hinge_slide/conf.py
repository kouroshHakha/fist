...
fewshot_dataset = KitchenStateSeqDataset(
    data_path='data/kitchen/kitchen-demo-kettle-bottomknob-hinge-slide.hdf5',
    subseq_len=10,
)

env = AttrDict(
    task_list = ['kettle', 'bottom burner', 'slide cabinet', 'hinge cabinet']
)
...
model_config = AttrDict(
    ...
    cond_decode=True,
    # checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/kitchen/hierarchical_cl_all'
)
