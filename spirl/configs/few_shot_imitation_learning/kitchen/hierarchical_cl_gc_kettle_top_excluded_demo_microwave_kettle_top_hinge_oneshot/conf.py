...
fewshot_dataset = KitchenStateSeqDataset(
    data_path='data/kitchen/kitchen-demo-microwave-kettle-topknob-hinge.hdf5',
    num_demo=1,
    subseq_len=10,
)
...
model_config = AttrDict(
    ...
    cond_decode=True,
    checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/kitchen/hierarchical_cl_gc_kettle_top_excluded'
)

# Dataset
data_config = AttrDict()
data_config.dataset_spec = data_spec
data_config.dataset_spec['dataset_path'] = './data/kitchen/kitchen-mixed-kettle-top-excluded.hdf5'
