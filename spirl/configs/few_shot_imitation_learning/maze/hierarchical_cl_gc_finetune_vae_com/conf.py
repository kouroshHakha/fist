...
from spirl.models.closed_loop_spirl_mdl import GoalCOMClSPiRLMdl
...
model_config = AttrDict(
    ...
    cond_decode=True,
    checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/maze/hierarchical_cl_state_gc_com_4M_B1024'
)
