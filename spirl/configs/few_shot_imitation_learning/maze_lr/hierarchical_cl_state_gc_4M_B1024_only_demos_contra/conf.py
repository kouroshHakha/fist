...
configuration = {
    ...
    'contra_ckpt': './data/maze/full/contrastive/exact_model.pt',
    'finetune_vae': False,
    'rst_data_path': 'data/maze/lr/rsts.npy'
}
...
model_config = AttrDict(
    ...
    cond_decode=True,
    checkpt_path=f'{os.environ["EXP_DIR"]}/skill_prior_learning/maze_lr/hierarchical_cl_state_gc_4M_B1024'
)
...
data_config['dataset_spec']['dataset_path'] = './data/maze/lr/blocked-4M.hdf5'
